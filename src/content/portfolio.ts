...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    logo: symphony3Logo,
    bullets: [
      '<span class="font-semibold text-slate-900">Developed and maintained end-to-end applications</span> with React and JavaScript frontends plus Java, Python, and C# backend services.',
      'Managed infrastructure maintenance and deployment workflows across AWS, Upsun, and cPanel to support reliable code delivery.',
      'Analyzed cloud resource usage, identified inefficiencies, and <span class="font-semibold text-slate-900">right-sized environments</span> to reduce operational overhead.',
      'Led technical integration work connecting platforms and services into unified, <span class="font-semibold text-slate-900">high-performance workflows</span>.',
      'Built a client call centre on <span class="font-semibold text-slate-900">Amazon Connect</span> handling 30+ calls daily, including a voicemail feature, sustaining strong feedback and performance over several years in production.',
      'Built <span class="font-semibold text-slate-900">BeetrixAI</span>, a chatroom UI where users ask questions and upload documents, which are stored in S3 and used as the data source for a Bedrock knowledge base behind the scenes.',
      '<span class="font-semibold text-slate-900">Delivered an AI agent integration</span> for client infringement review using AWS Bedrock AgentCore, CodeBuild, S3, Lambda, and EventBridge, reusing the BeetrixAI UI to give the client visibility and cutting daily review time from several hours to under one hour.',
      'Integrated <span class="font-semibold text-slate-900">IFS</span> with PDF Generator API and SMTP to automate document generation and email delivery workflows.',
      'Built <span class="font-semibold text-slate-900">SmartGlue</span>, a client-facing integration transaction tracking tool with a user-friendly UI and username/password login, using React (Vite) and .NET, deployed on AWS Amplify and ECS with an RDS database.',
    ],
    skills: ["React", "JavaScript", "Java", "Python", "C#", ".NET", "AWS", "Amazon Connect", "BeetrixAI", "Bedrock AgentCore", "Bedrock Knowledge Base", "Lambda", "EventBridge", "CodeBuild", "S3", "AWS Amplify", "ECS", "RDS", "IFS", "PDF Generator API", "SMTP", "Upsun", "cPanel", "Systems Integration"],
  },
  {
    ...
    logo: filaLogo,
    bullets: [
      'Supported customers at <span class="font-semibold text-slate-900">Melbourne DFO South Wharf</span> in a high-traffic retail environment.',
      'Handled <span class="font-semibold text-slate-900">multilingual communication</span>, cashiering, product queries, and store-floor support with care and consistency.',
      'Built strong <span class="font-semibold text-slate-900">service habits</span> around communication, prioritisation, and calm problem-solving under pressure.',
    ],
  ...
  },
  {
    ...
    bullets: [
      'Developed and maintained <span class="font-semibold text-slate-900">full-stack features</span> using React, Python, and PostgreSQL.',
      'Managed AWS cloud infrastructure components and deployment workflows while building hands-on cloud experience.',
      'Supported <span class="font-semibold text-slate-900">Agile delivery</span> by facilitating daily stand-ups and tracking sprint progress in Jira and Bitbucket.',
      'Streamlined <span class="font-semibold text-slate-900">DevOps operations</span> through repository management, issue tracking, and cross-platform delivery coordination.',
    ],
  ...
  },
  {
    ...
    logo: blackBallLogo,
    bullets: [
      'Maintained <span class="font-semibold text-slate-900">quality and speed</span> in a fast-paced service environment during peak traffic periods.',
      'Followed detailed recipes, food safety protocols, and <span class="font-semibold text-slate-900">standard operating procedures</span> to keep product quality consistent.',
      'Monitored <span class="font-semibold text-slate-900">stock levels</span> and coordinated replenishment to prevent downtime in shop operations.',
      'Assisted with basic troubleshooting for <span class="font-semibold text-slate-900">POS systems</span> and digital payment terminals.',
    ],
